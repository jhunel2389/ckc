...
@section('content')
                      ...
                      <td>
                        ...
                        <form action="{{ route('updateEmployeeRoles') }}" method="POST" id="formUpdateStatus">
                          ...
                          @if($utils::checkPermissions('delete_teams'))
                            ...
                            <input type="hidden" id="er_status_id" name="er_status_id">
                          @endif
                          @if($utils::checkPermissions('edit_teams'))
                            <button type="button" class="btn btn-xs" data-toggle="modal" data-target="#modal-form-tools"><i class="fa fa-tools" title="Tools"></i></button>
                          @endif
                        </form>
                      </td>
                    </tr>
      ...
      <div class="modal fade" id="modal-form">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <form action="{{ route('addEmployeeRoles') }}" method="POST" id="formAdd">
                @csrf
                <div class="modal-body">
                    <!-- form start -->
                      <div class="card-body">
                        <div class="form-group">
                          <label for="er_name">Employee Role Name</label>
                          <input type="text" class="form-control" id="name" name="name" value="" placeholder="Enter employee tool name" required>
                        </div>
                        @error('tool_name')
    ...
    @if($utils::checkPermissions('edit_teams'))
      <!-- ADD MODAL -->
      <div class="modal fade" id="modal-form-tools">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="modal-h4">Manage Tools List</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
    ...
    @section('custom_script')
      <script>
        ...
        $('#submitBtn').click(function() {
             ...
             $('#confirm_submit').attr("onclick","submit_form('formAdd')");
        });
